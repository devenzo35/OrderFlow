...
Revision ID: 09d4f25a9486
Revises: 80fdcd22ac9a
Create Date: 2025-07-30 16:52:53.213614
...
revision: str = '09d4f25a9486'
down_revision: Union[str, Sequence[str], None] = '80fdcd22ac9a'
...
def downgrade() -> None:
    ...
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('type', postgresql.ENUM('INCOME', 'EXPENSE', 'INVESTMENT', name='movementtype'), autoincrement=False, nullable=False),
